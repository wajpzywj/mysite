...
from .views import AboutView, CourseListView, ManageCourseListView, CreateCourseView, \
    DeleteCourseView, CreateLessonView, ListLessonView, DetailLessonView, StudentListLessonView, StudentDetailLessonView
...
urlpatterns = [
    ...
    url(r'lesson-detail/(?P<lesson_id>\d+)/$', StudentDetailLessonView.as_view(), name='lesson_detail'),
]